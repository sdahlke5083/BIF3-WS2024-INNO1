...
$string['custom_color_1_help']    = 'Hex code for custom color 1.';
$string['custom_color_2_help']    = 'Hex code for custom color 2.';
$string['custom_color_3_help']    = 'Hex code for custom color 3.';
$string['custom_color_4_help']    = 'Hex code for custom color 4.';
$string['custom_color_5_help']    = 'Hex code for custom color 5.';
